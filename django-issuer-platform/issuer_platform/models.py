...
class Company(models.Model):
    ...
    # Issuer branding for NFT certificates
    logo_url = models.URLField(
        max_length=500,
        null=True,
        blank=True,
        help_text="Company logo URL for NFT certificates"
    )
    logo_ipfs_hash = models.CharField(
        max_length=100,
        null=True,
        blank=True,
        help_text="IPFS hash for company logo (permanent storage)"
    )
    description = models.TextField(
        blank=True,
        help_text="Company description for NFT certificates"
    )
