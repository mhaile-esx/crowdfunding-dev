...
def connect_wallet(request):
    """
    Connect external wallet (mobile/MetaMask) to authenticated user account
    
    SECURITY: Requires JWT authentication + cryptographic signature
...
def generate_wallet(request):
    ...
    Server-side wallet generation for users without MetaMask.
    The private key is encrypted and stored securely.
    
    Returns:
        - wallet_address: The generated Ethereum address
